...
extern int IK_LLAMA_BUILD_NUMBER;
...
struct gpt_params {
    ...
    int32_t max_gpu_per_split               =       0; // max number of GPUs to use at a time for split mode "graph"
    int32_t split_adjust_step_frequency     =       2; // multiplicator for adjust_step calculation in split mode "graph"
