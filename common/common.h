...
struct gpt_params {
    ...
    int32_t ctx_checkpoints_n = 4;            // max number of context checkpoints per slot
    int32_t ctx_checkpoints_interval = 1024;   // minimum number of tokens between each context checkpoints
    int32_t ctx_checkpoints_tolerance = 3;    // the number of tokens before the full prompt to create the checkpoint 
