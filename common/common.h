...
struct gpt_params {
    ...
    bool split_mode_bf16   = false; // if true, intermediate results will be cast to bf16 before copying to other GPUs to perform reduce ops
    bool split_mode_f32    = false; // if true, intermediate results will be cast to f32 before copying to other GPUs to perform reduce ops
