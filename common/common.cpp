...
bool gpt_params_find_arg(int argc, char ** argv, const std::string & arg, gpt_params & params, int & i, bool & invalid_param) {
    ...
    if (arg == "-sgs" || arg == "--split-graph-scheduling") {
        params.split_graph_scheduling = true;
        return true;
    }
    if (arg == "--numa") {
        CHECK_ARG
...
void gpt_params_print_usage(int /*argc*/, char ** argv, const gpt_params & params) {
    ...
    options.push_back({ "*",         "-sgs, --split-graph-scheduling,",  "Force Split (Mode) Graph Scheduling (default: %d)", params.split_graph_scheduling});
...
void yaml_dump_non_result_info(FILE * stream, const gpt_params & params, const llama_context * lctx,
    ...
    fprintf(stream, "split_graph_scheduling: %s # default: false\n", params.split_graph_scheduling ? "true" : "false");
