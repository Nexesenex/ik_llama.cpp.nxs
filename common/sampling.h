...
#define X_COMMON_PARAMS_SAMPLING                                 /*  \
    ...
    */  X( float   , break_endless_sentences , 0.0f ,            )  /*  0.0 = disabled; boost sentence-end logits (".", "?", "!") and reduce continuation logits (",", ";", "-") by N percent per generated token since the previous sentence end \
    */
