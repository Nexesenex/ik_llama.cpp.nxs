...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_IQ1_KT        = 156, // except 1d tensors
                                                //
        LLAMA_FTYPE_MOSTLY_IQ5_NL        = 180, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q6_1          = 181, // except 1d tensors
                                                //
    ...
    struct llama_context_params {
        ...
        bool pipeline;          // if true, enable preloader lookahead pipeline (experimental)
