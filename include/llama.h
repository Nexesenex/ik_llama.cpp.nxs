...
extern "C" {
    ...
    enum llama_ftype {
        ...
        //
        LLAMA_FTYPE_MOSTLY_IQ3_KMAX      = 260, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_KSSN      = 261, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_KSN       = 262, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_KN        = 263, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ5_KN        = 264, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ6_KN        = 265, // except 1d tensors
