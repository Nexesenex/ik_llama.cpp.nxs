...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_IQ3_X145L     = 110, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ3_X15L      = 111, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ3_EXL       = 112, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ3_SXL       = 113, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ3_UXL       = 114, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q3_K_XL       = 115, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_XXSR      = 116, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_XSR       = 117, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_MR        = 118, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_LR        = 119, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q5_K_XS1R     = 120, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q5_K_S2R      = 121, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q5_K_M3L      = 122, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_Q5_K_X4L      = 123, // except 1d tensors
