...
static void usage(const char * executable) {
    ...
    printf("Specific tensor quantization type overrides to be applied over the selected quantization scheme:\n");
