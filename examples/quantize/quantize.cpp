...
static const std::vector<struct quant_option> QUANT_OPTIONS = {
    ...
    { "IQ3_KMAX", LLAMA_FTYPE_MOSTLY_IQ3_KMAX,  " 3.8 bpw non-linear quantization",  },
    { "IQ4_KSSN", LLAMA_FTYPE_MOSTLY_IQ4_KSSN, " 3.95 bpw non-linear quantization", },
    { "IQ4_KSN",  LLAMA_FTYPE_MOSTLY_IQ4_KSN,  " 4.2 bpw non-linear quantization",  },
    { "IQ4_KN",   LLAMA_FTYPE_MOSTLY_IQ4_KN,   " 4.45 bpw non-linear quantization", },
    { "IQ5_KN",   LLAMA_FTYPE_MOSTLY_IQ5_KN,   " 5.4 bpw non-linear quantization",  },
    { "IQ6_KN",   LLAMA_FTYPE_MOSTLY_IQ6_KN,   " 6.5 bpw non-linear quantization",  },
