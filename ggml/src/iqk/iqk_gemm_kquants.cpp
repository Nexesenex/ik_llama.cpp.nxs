...
static void mul_mat_iq4_xs_r8_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 8) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto sl_h = _mm256_blend_epi32(_mm256_slli_epi16(_mm256_broadcastsi128_si256(slbits_h), 4), _mm256_broadcastsi128_si256(slbits_h), 0xF0);
            auto sh_h = _mm256_blend_epi32(_mm256_slli_epi16(_mm256_broadcastsi128_si256(shbits_h), 4), _mm256_broadcastsi128_si256(shbits_h), 0xF0);
...
static void mul_mat_q4_k_r4_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto hbits = _mm256_blend_epi32(_mm256_slli_epi16(_mm256_broadcastsi128_si256(hbits128), 4), _mm256_broadcastsi128_si256(hbits128), 0xF0);
