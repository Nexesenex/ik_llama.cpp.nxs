...
static void mul_mat_iq4_xs_r8_q8_k_avx2(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 8) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto sh = _mm256_blend_epi32(_mm256_broadcastsi128_si256(shbits), _mm256_srli_epi16(_mm256_broadcastsi128_si256(shbits), 2), 0xF0);
...
#ifdef HAVE_VNNI256
                    auto y_shuf0 = _mm256_shuffle_epi32(y, 0x00);
                    auto y_shuf1 = _mm256_shuffle_epi32(y, 0x55);
                    auto y_shuf2 = _mm256_shuffle_epi32(y, 0xaa);
                    auto y_shuf3 = _mm256_shuffle_epi32(y, 0xff);
                    const __m256i zero = _mm256_setzero_si256();
                    auto d0 = ggml_mm256_dpbusd_epi32(zero, qx[0], y_shuf0);
                    auto d1 = ggml_mm256_dpbusd_epi32(zero, qx[1], y_shuf1);
                    auto d2 = ggml_mm256_dpbusd_epi32(zero, qx[2], y_shuf2);
                    auto d3 = ggml_mm256_dpbusd_epi32(zero, qx[3], y_shuf3);
                    auto sumi = _mm256_add_epi32(_mm256_add_epi32(d0, d1), _mm256_add_epi32(d2, d3));
...
static void mul_mat_iq4_xs_r8_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 8) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto sl_l = _mm256_blend_epi32(_mm256_broadcastsi128_si256(slbits_l), _mm256_srli_epi16(_mm256_broadcastsi128_si256(slbits_l), 4), 0xF0);
            auto sh_l = _mm256_blend_epi32(_mm256_broadcastsi128_si256(shbits_l), _mm256_srli_epi16(_mm256_broadcastsi128_si256(shbits_l), 4), 0xF0);
            ...
            auto sl_h = _mm256_blend_epi32(_mm256_broadcastsi128_si256(slbits_h), _mm256_slli_epi16(_mm256_broadcastsi128_si256(slbits_h), 4), 0x0F);
            auto sh_h = _mm256_blend_epi32(_mm256_broadcastsi128_si256(shbits_h), _mm256_slli_epi16(_mm256_broadcastsi128_si256(shbits_h), 4), 0x0F);
...
static void mul_mat_q2_k_r4_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto d4 = _mm256_permute2f128_ps(dm, dm, 0x00);
            auto m4 = _mm256_permute2f128_ps(dm, dm, 0x11);
...
static void mul_mat_q3_k_r4_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto shb = _mm256_blend_epi32(_mm256_broadcastsi128_si256(shbits), _mm256_srli_epi16(_mm256_broadcastsi128_si256(shbits), 2), 0xF0);
            ...
            _mm256_storeu_si256((__m256i *)scales+1, scales2);
            {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    isum[iy] = sumi;
#elif defined(HAVE_VNNI256)
                    auto bsums_shuf0 = _mm256_shuffle_epi32(bsums, 0x00);
                    auto bsums_shuf1 = _mm256_shuffle_epi32(bsums, 0x55);
                    auto bsums_shuf2 = _mm256_shuffle_epi32(bsums, 0xaa);
                    auto bsums_shuf3 = _mm256_shuffle_epi32(bsums, 0xff);
                    const __m256i zero = _mm256_setzero_si256();
                    auto d0 = ggml_mm256_dpwssd_epi32(zero, s1, bsums_shuf0);
                    auto d1 = ggml_mm256_dpwssd_epi32(zero, s2, bsums_shuf1);
                    auto d2 = ggml_mm256_dpwssd_epi32(zero, s3, bsums_shuf2);
                    auto d3 = ggml_mm256_dpwssd_epi32(zero, s4, bsums_shuf3);
                    sumi = _mm256_add_epi32(_mm256_add_epi32(d0, d1), _mm256_add_epi32(d2, d3));
                    if constexpr (nrc_y == 1) {
            ...
            for (int ib = 0; ib < QK_K/32; ++ib) {
                ...
                auto hb = _mm256_blend_epi32(_mm256_broadcastsi128_si256(hbits), _mm256_slli_epi16(_mm256_broadcastsi128_si256(hbits), 4), 0x0F);
...
static void mul_mat_q4_k_r4_q8_k(int n, const void * vx, size_t bx, const DataInfo& info, int nrc_x) {
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            auto d4 = _mm256_permute2f128_ps(dl, dl, 0x00);
            auto m4 = _mm256_mul_ps(_mm256_set1_ps(-1.0f), _mm256_permute2f128_ps(dl, dl, 0x11));
            auto lbits = _mm256_loadu_si256((const __m256i *)iq4[ibl].scales_l);
            auto hbits128 = _mm_loadu_si128((const __m128i *)iq4[ibl].scales_h);
            auto hbits = _mm256_blend_epi32(_mm256_broadcastsi128_si256(hbits128), _mm256_slli_epi16(_mm256_broadcastsi128_si256(hbits128), 4), 0x0F);
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            for (int ib = 0; ib < QK_K/16; ++ib) {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    auto y_shuf3 = _mm256_shuffle_epi32(y, 0xff);
                    const __m256i zero = _mm256_setzero_si256();
                    auto d0 = ggml_mm256_dpbusd_epi32(zero, s0, _mm256_sign_epi8(y_shuf0, qx[0]));
                    auto d1 = ggml_mm256_dpbusd_epi32(zero, s1, _mm256_sign_epi8(y_shuf1, qx[1]));
                    auto d2 = ggml_mm256_dpbusd_epi32(zero, s2, _mm256_sign_epi8(y_shuf2, qx[2]));
                    auto d3 = ggml_mm256_dpbusd_epi32(zero, s3, _mm256_sign_epi8(y_shuf3, qx[3]));
                    isum[iy] = _mm256_add_epi32(isum[iy], _mm256_add_epi32(_mm256_add_epi32(d0, d1), _mm256_add_epi32(d2, d3)));
#else
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int i = 0; i < n/32; ++i) {
            ...
            for (int iy = 0; iy < nrc_y; ++iy) {
                ...
                auto d2 = ggml_mm256_dpbusd_epi32(zero, qx[2], y_shuf2);
                auto d3 = ggml_mm256_dpbusd_epi32(zero, qx[3], y_shuf3);
                acc[iy] = _mm256_add_epi32(acc[iy], _mm256_add_epi32(_mm256_add_epi32(d0, d1), _mm256_add_epi32(d2, d3)));
#else
        ...
        for (int i = 0; i < nb; ++i) {
            for (int k = 0; k < k_nr; ++k) {
                ...
                for (int ib32 = 0; ib32 < 8; ++ib32) {
                    ...
                    xv[ib32] = _mm256_and_si256(_mm256_blend_epi32(_mm256_broadcastsi128_si256(bits), _mm256_srli_epi16(_mm256_broadcastsi128_si256(bits), 4), 0xF0), _mm256_set1_epi8(0xf));
