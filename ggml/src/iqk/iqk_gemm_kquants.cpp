        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            for (int ib = 0; ib < QK_K/32; ++ib) {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    sumi = _mm256_dpbusd_epi32(sumi, _mm256_sign_epi8(qx[0], qx[0]), _mm256_sign_epi8(y00, qx[0]));
                    sumi = _mm256_dpbusd_epi32(sumi, _mm256_sign_epi8(qx[1], qx[1]), _mm256_sign_epi8(y55, qx[1]));
                    sumi = _mm256_dpbusd_epi32(sumi, _mm256_sign_epi8(qx[2], qx[2]), _mm256_sign_epi8(yaa, qx[2]));
                    sumi = _mm256_dpbusd_epi32(sumi, _mm256_sign_epi8(qx[3], qx[3]), _mm256_sign_epi8(yff, qx[3]));
                    isum[iy] = _mm256_add_epi32(isum[iy], _mm256_mullo_epi32(iscales, sumi));
#else
                    auto sumi1 = _mm256_maddubs_epi16(_mm256_sign_epi8(qx[0], qx[0]), _mm256_sign_epi8(_mm256_shuffle_epi32(y, 0x00), qx[0]));
                    auto sumi2 = _mm256_maddubs_epi16(_mm256_sign_epi8(qx[1], qx[1]), _mm256_sign_epi8(_mm256_shuffle_epi32(y, 0x55), qx[1]));
                    auto sumi3 = _mm256_maddubs_epi16(_mm256_sign_epi8(qx[2], qx[2]), _mm256_sign_epi8(_mm256_shuffle_epi32(y, 0xaa), qx[2]));
                    auto sumi4 = _mm256_maddubs_epi16(_mm256_sign_epi8(qx[3], qx[3]), _mm256_sign_epi8(_mm256_shuffle_epi32(y, 0xff), qx[3]));
                    auto sumi  = _mm256_add_epi32(_mm256_madd_epi16(iscales, sumi1), _mm256_madd_epi16(iscales, sumi2));
                    sumi = _mm256_add_epi32(sumi, _mm256_madd_epi16(iscales, sumi3));
                    sumi = _mm256_add_epi32(sumi, _mm256_madd_epi16(iscales, sumi4));
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            for (int ib = 0; ib < QK_K/32; ++ib) {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    sumi = _mm512_dpbusd_epi32(sumi, _mm512_sign_epi8(qx[0], qx[0]), _mm512_sign_epi8(y00, qx[0]));
                    sumi = _mm512_dpbusd_epi32(sumi, _mm512_sign_epi8(qx[1], qx[1]), _mm512_sign_epi8(y55, qx[1]));
                    sumi = _mm512_dpbusd_epi32(sumi, _mm512_sign_epi8(qx[2], qx[2]), _mm512_sign_epi8(yaa, qx[2]));
                    sumi = _mm512_dpbusd_epi32(sumi, _mm512_sign_epi8(qx[3], qx[3]), _mm512_sign_epi8(yff, qx[3]));
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            _mm256_storeu_si256((__m256i *)scales+1, scales2);
            {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    auto sumi = _mm256_dpwssd_epi32(_mm256_setzero_si256(), s1, bsums00);
                    sumi = _mm256_dpwssd_epi32(sumi, s2, bsums55);
                    sumi = _mm256_dpwssd_epi32(sumi, s3, bsumsaa);
                    sumi = _mm256_dpwssd_epi32(sumi, s4, bsumsff);
                    isum[iy] = sumi;
#elif defined(HAVE_VNNI256)
                    auto bsums00 = _mm256_shuffle_epi32(bsums, 0x00);
                    auto bsums55 = _mm256_shuffle_epi32(bsums, 0x55);
                    ...
                    auto bsumsaa = _mm256_shuffle_epi32(bsums, 0xaa);
                    auto bsumsff = _mm256_shuffle_epi32(bsums, 0xff);
                    auto sumi = _mm256_madd_epi16(s1, bsums00);
                    sumi = _mm256_add_epi32(sumi, _mm256_madd_epi16(s2, bsums55));
                    sumi = _mm256_add_epi32(sumi, _mm256_madd_epi16(s3, bsumsaa));
                    sumi = _mm256_add_epi32(sumi, _mm256_madd_epi16(s4, bsumsff));
                    if constexpr (nrc_y == 1) {
                        acc[iy] = _mm256_fmadd_ps(min, _mm256_cvtepi32_ps(sumi), acc[iy]);
                    } else {
                        acc[iy] = _mm256_fmadd_ps(_mm256_mul_ps(min, _mm256_set1_ps(q8.scale(iy, ibl))), _mm256_cvtepi32_ps(sumi), acc[iy]);
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            for (int ib = 0; ib < QK_K/16; ++ib) {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    auto yaa = _mm256_shuffle_epi32(y, 0xaa);
                    auto yff = _mm256_shuffle_epi32(y, 0xff);
                    isum[iy] = _mm256_dpbusd_epi32(isum[iy], s0, _mm256_sign_epi8(y00, qx[0]));
                    isum[iy] = _mm256_dpbusd_epi32(isum[iy], s1, _mm256_sign_epi8(y55, qx[1]));
                    isum[iy] = _mm256_dpbusd_epi32(isum[iy], s2, _mm256_sign_epi8(yaa, qx[2]));
                    isum[iy] = _mm256_dpbusd_epi32(isum[iy], s3, _mm256_sign_epi8(yff, qx[3]));
#else
                    auto y00 = _mm256_shuffle_epi32(y, 0x00);
                    auto y55 = _mm256_shuffle_epi32(y, 0x55);
                    auto yaa = _mm256_shuffle_epi32(y, 0xaa);
                    auto yff = _mm256_shuffle_epi32(y, 0xff);
                    auto sumi1 = _mm256_madd_epi16(m1, _mm256_maddubs_epi16(s0, _mm256_sign_epi8(y00, qx[0])));
                    auto sumi2 = _mm256_madd_epi16(m1, _mm256_maddubs_epi16(s1, _mm256_sign_epi8(y55, qx[1])));
                    auto sumi3 = _mm256_madd_epi16(m1, _mm256_maddubs_epi16(s2, _mm256_sign_epi8(yaa, qx[2])));
                    auto sumi4 = _mm256_madd_epi16(m1, _mm256_maddubs_epi16(s3, _mm256_sign_epi8(yff, qx[3])));
        ...
        for (int ibl = 0; ibl < nbl; ++ibl) { // Block of 256
            ...
            for (int ib = 0; ib < QK_K/16; ++ib) {
                ...
                for (int iy = 0; iy < nrc_y; ++iy) {
                    ...
                    auto yaa = _mm512_shuffle_epi32(y, _MM_PERM_ENUM(0xaa));
                    auto yff = _mm512_shuffle_epi32(y, _MM_PERM_ENUM(0xff));
                    isum[iy] = _mm512_dpbusd_epi32(isum[iy], qx[0], y00);
                    isum[iy] = _mm512_dpbusd_epi32(isum[iy], qx[1], y55);
                    isum[iy] = _mm512_dpbusd_epi32(isum[iy], qx[2], yaa);
                    isum[iy] = _mm512_dpbusd_epi32(isum[iy], qx[3], yff);
                }
            }
    ...
    for (int ix = 0; ix < nrc_x; ix += 4) {
        ...
        for (int i = 0; i < n/32; ++i) {
            ...
            for (int iy = 0; iy < nrc_y; ++iy) {
                ...
                auto yaa = _mm256_shuffle_epi32(y, 0xaa);
                auto yff = _mm256_shuffle_epi32(y, 0xff);
                acc[iy] = _mm256_dpbusd_epi32(acc[iy], qx[0], y00);
                acc[iy] = _mm256_dpbusd_epi32(acc[iy], qx[1], y55);
                acc[iy] = _mm256_dpbusd_epi32(acc[iy], qx[2], yaa);
                acc[iy] = _mm256_dpbusd_epi32(acc[iy], qx[3], yff);
#else
                auto y00 = _mm256_shuffle_epi32(y, 0x00);
                auto y55 = _mm256_shuffle_epi32(y, 0x55);
                auto yaa = _mm256_shuffle_epi32(y, 0xaa);
                auto yff = _mm256_shuffle_epi32(y, 0xff);
                auto dot1 = _mm256_maddubs_epi16(sx[0], _mm256_sign_epi8(y00, qx[0]));
                auto dot2 = _mm256_maddubs_epi16(sx[1], _mm256_sign_epi8(y55, qx[1]));
                auto dot3 = _mm256_maddubs_epi16(sx[2], _mm256_sign_epi8(yaa, qx[2]));
                auto dot4 = _mm256_maddubs_epi16(sx[3], _mm256_sign_epi8(yff, qx[3]));
                auto dot12 = _mm256_madd_epi16(m1, dot1);
                dot12 = _mm256_add_epi32(dot12, _mm256_madd_epi16(m1, dot2));
                auto dot34 = _mm256_madd_epi16(m1, dot3);
                dot34 = _mm256_add_epi32(dot34, _mm256_madd_epi16(m1, dot4));
    ...
    for (int ix = 0; ix < nrc_x; ix += 8) {
        ...
        for (int ib = 0; ib < nb; ++ib) { // Blocks of 16 for 8 interleaved rows
            ...
            for (int iy = 0; iy < nrc_y; ++iy) {
                ...
                auto yaa = _mm256_shuffle_epi32(y, 0xaa);
                auto yff = _mm256_shuffle_epi32(y, 0xff);
                auto sumi1 = _mm256_maddubs_epi16(s0, _mm256_sign_epi8(y00, qx[0]));
                auto sumi2 = _mm256_maddubs_epi16(s1, _mm256_sign_epi8(y55, qx[1]));
                auto sumi3 = _mm256_maddubs_epi16(s2, _mm256_sign_epi8(yaa, qx[2]));
                auto sumi4 = _mm256_maddubs_epi16(s3, _mm256_sign_epi8(yff, qx[3]));
                auto sumi12 = _mm256_madd_epi16(m1, sumi1);
                sumi12 = _mm256_add_epi32(sumi12, _mm256_madd_epi16(m1, sumi2));
                auto sumi34 = _mm256_madd_epi16(m1, sumi3);
                sumi34 = _mm256_add_epi32(sumi34, _mm256_madd_epi16(m1, sumi4));
