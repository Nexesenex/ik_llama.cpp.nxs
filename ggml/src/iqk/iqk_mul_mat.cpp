...
struct MulMat {
    ...
    static inline ggml_type is_dequant_better(ggml_type type, int nrc_y) {
        ...
        switch (type) {
            ...
            case GGML_TYPE_IQ6_KS : return nrc_y >= 32 ? q8_k_type : type;
            ...
            case GGML_TYPE_Q6_1_R4: return nrc_y >= 32 ? GGML_TYPE_Q8_1    : type;
        ...
        switch (type) {
            ...
            case GGML_TYPE_IQ6_KS : return nrc_y >= 32 ? GGML_TYPE_Q8_K_R8 : type;
            default: break;
        }
#endif
        return type;
    ...
    static inline int num_rows([[maybe_unused]] ggml_type type) {
        ...
        switch (type) {
            ...
            case GGML_TYPE_MXFP4_R8: return 8;
