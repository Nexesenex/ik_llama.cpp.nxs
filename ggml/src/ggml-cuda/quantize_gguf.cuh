...
// reference functions make_qx_quants / quantize_row_q4_0_impl in ggml-quants.c
// to be compiled with #pragma STDC FP_CONTRACT OFF (as they now are), so a
// /arch:AVX2 build cannot FMA-contract sumlx += w*x*l and drift by ~1 ulp.
//
// Currently implemented: Q8_0 (ref), Q4_0 (ref), Q4_0 with importance matrix.
//
