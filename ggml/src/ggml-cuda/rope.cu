...
static __global__ void rope_norm(
        ...
        const rope_corr_dims corr_dims, const float theta_scale, const float * freq_factors, const uint3 ne1_fd, bool is_flipped) {
...
static void rope_norm_cuda(
    ...
    if (freq_factors == nullptr) {
        rope_norm<forward, false><<<block_nums, block_dims, 0, stream>>>(
            ...
            attn_factor, corr_dims, theta_scale, freq_factors, ne1_fd, is_flipped);
    } else {
