...
static __global__ void mul_mat_q_id(
        ...
        const uint3 blocks_per_ne00, const int ncols_x, const int nrows_x, const int ncols_dst, const int stride_row_x, const int ncols_y, const int stride_col_dst,
...
static void launch_mul_mat_q_id_impl(ggml_backend_cuda_context & ctx, const mmq_args_id & args, cudaStream_t stream) {
    ...
    const uint3 blocks_per_ne00_fd = init_fastdiv_values((args.ncols_x + ggml_cuda_type_traits<type>::qk - 1) / ggml_cuda_type_traits<type>::qk);
        ...
        if (args.nrows_x % mmq_y == 0) {
            ...
            mul_mat_q_id<type, mmq_x, need_check, has_tail><<<block_nums_xy_tiling, block_dims, nbytes_shared, stream>>>
                (args.x, args.y, args.ids_dst, args.expert_bounds, args.dst, nullptr,
                 blocks_per_ne00_fd, args.ncols_x, args.nrows_x, args.ncols_dst, args.stride_row_x, args.ncols_y, args.nrows_dst,
