...
#define _GGML_STDIO_TARGET GGML_MAX_CONTEXTS
    ...
    // TODO: make optional
    {
        ...
        switch (type_max) {
            ...
            case GGML_TYPE_MXFP4_R8:ftype = LLAMA_FTYPE_MOSTLY_MXFP4_R8;break;
            ...
            case GGML_TYPE_IQ6_KS:  ftype = LLAMA_FTYPE_MOSTLY_IQ6_KS;  break;
            case GGML_TYPE_IQ6_KS_R4:ftype = LLAMA_FTYPE_MOSTLY_IQ6_KS_R4;break;
