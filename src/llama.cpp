...
struct llama_context * llama_new_context_with_model(
    ...
    cparams.split_graph_scheduling = params.split_graph_scheduling;
    ...
    LLAMA_LOG_INFO("%s: split_graph_scheduling = %d\n",   __func__, cparams.split_graph_scheduling);
    ...
    if (model->split_mode == LLAMA_SPLIT_MODE_GRAPH && (!model->has_tensor_overrides() || cparams.split_graph_scheduling == 1)) {
        ggml_backend_sched_set_split_mode_graph(ctx->sched, true);
        LLAMA_LOG_INFO("======================================= Split mode graph scheduling: ON\n");
    } else {
        LLAMA_LOG_INFO("======================================= Split mode graph scheduling: OFF\n");
    } 
