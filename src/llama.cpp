...
static int llama_model_load(const std::string & fname, llama_model & model, llama_model_params & params) {
    try {
        ...
        if (!llm_load_tensors(
            ml, model, params.n_gpu_layers, params.mla, params.split_mode,  params.main_gpu, params.max_gpu_per_split, params.split_adjust_step_frequency, params.tensor_split,
