...
static ggml_type llama_tensor_get_type(quantize_state_internal & qs, ggml_type new_type, const ggml_tensor * tensor, llama_ftype ftype) {
    ...
    if (name == tn(LLM_TENSOR_OUTPUT, "weight") || (!qs.has_output && name == tn(LLM_TENSOR_TOKEN_EMBD, "weight"))) {
        ...
        if      (qs.params->attn_v_type < GGML_TYPE_COUNT) new_type = qs.params->attn_v_type;
        ...
        else if (ftype == LLAMA_FTYPE_MOSTLY_IQ5_NL && qs.model.hparams.n_gqa() >= 2) {
            ...
            else if (new_type == GGML_TYPE_IQ5_NL) new_type = GGML_TYPE_Q6_0;
        ...
        else if (i_layer < n_layer/8 && !qs.has_imatrix && ftype == LLAMA_FTYPE_MOSTLY_IQ5_NL) {
            new_type = GGML_TYPE_Q6_0;
        }
        ...
        if (qs.params->attn_output_type < GGML_TYPE_COUNT) new_type = qs.params->attn_output_type;
            ...
            if (qs.model.hparams.n_expert >= 4) {
                ...
                else if (ftype == LLAMA_FTYPE_MOSTLY_IQ5_NL) {
                    new_type = GGML_TYPE_Q6_0;
                }
            } else {
...
static void llama_model_quantize_internal(const std::string & fname_inp, const std::string & fname_out, const llama_model_quantize_params * params) {
    ...
    switch (ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_IQ5_NL:  default_type = GGML_TYPE_IQ5_NL;  break;
    ...
    llama_model_loader ml(fname_inp, 0, use_mmap, /*check_tensors*/ true, /* repack_tensors */ false,
            /* use_thp */ false, /* merge_qkv */ false, /* merge_up_gate_exps */ false, /* merge_up_gate_shexp */ false,
